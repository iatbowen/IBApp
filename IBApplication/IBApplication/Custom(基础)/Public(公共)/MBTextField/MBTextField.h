 ...
 */
- (void)textField:(MBTextField *)textField didPreventTextChangeInRange:(NSRange)range replacementString:(nullable NSString *)replacementString;
...
@property (nonatomic, weak) id<MBTextFieldDelegate> delegate;
